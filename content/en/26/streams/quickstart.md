...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/2.6.3/kafka_2.13-2.6.3.tgz "Kafka downloads") the 2.6.3 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/26/images/streams-table-updates-02.png) ![](/26/images/streams-table-updates-01.png)
...
[Previous](/26/streams) [Next](/26/streams/tutorial)
