...
Additional documentation on using the Streams API is available [here](/26/documentation/streams). 
...
When using Scala you may optionally include the `kafka-streams-scala` library. Additional documentation on using the Kafka Streams DSL for Scala is available [in the developer guide](/26/documentation/streams/developer-guide/dsl-api.html#scala-dsl). 
