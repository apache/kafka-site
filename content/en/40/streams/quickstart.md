...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/4.0.2/kafka_2.13-4.0.2.tgz "Kafka downloads") the 4.0.2 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here:
...
![](/40/images/streams-table-updates-02.png) ![](/40/images/streams-table-updates-01.png)
