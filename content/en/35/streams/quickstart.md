...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/3.5.2/kafka_2.13-3.5.2.tgz "Kafka downloads") the 3.5.2 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/35/images/streams-table-updates-02.png) ![](/35/images/streams-table-updates-01.png)
...
[Previous](/35/streams) [Next](/35/streams/tutorial)
