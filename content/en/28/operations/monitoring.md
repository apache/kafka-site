...
{{< include-html file="/static/28/generated/producer_metrics.html" >}} 
...
All of the following metrics have a recording level of `debug`, except for the dropped-records-*, active-process-ratio, and record-e2e-latency-* metrics which have a recording level of `info`:   
<table>  
<tr>  
<th>
