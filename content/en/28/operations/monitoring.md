...
All of the following metrics have a recording level of `debug`, except for the dropped-records-*, active-process-ratio, and record-e2e-latency-* metrics which have a recording level of `info`:  Metric/Attribute name | Description | Mbean name  
---|---|---  
