...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/2.8.2/kafka_2.13-2.8.2.tgz "Kafka downloads") the 2.8.2 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/28/images/streams-table-updates-02.png) ![](/28/images/streams-table-updates-01.png)
...
[Previous](/28/streams) [Next](/28/streams/tutorial)
