...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/3.1.1-SNAPSHOT/kafka_2.13-3.1.1-SNAPSHOT.tgz "Kafka downloads") the 3.1.1-SNAPSHOT release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/31/images/streams-table-updates-02.png) ![](/31/images/streams-table-updates-01.png)
...
[Previous](/31/streams) [Next](/31/streams/tutorial)
