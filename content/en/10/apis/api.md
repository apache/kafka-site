...
Examples showing how to use the producer are given in the [javadocs](/10/javadoc/index.html?org/apache/kafka/clients/producer/KafkaProducer.html "Kafka 1.0 Javadoc"). 
...
Examples showing how to use the consumer are given in the [javadocs](/10/javadoc/index.html?org/apache/kafka/clients/consumer/KafkaConsumer.html "Kafka 1.0 Javadoc"). 
...
Those who want to implement custom connectors can see the [javadoc](/10/javadoc/index.html?org/apache/kafka/connect "Kafka 1.0 Javadoc"). 
...
For more information about the AdminClient APIs, see the [javadoc](/10/javadoc/index.html?org/apache/kafka/clients/admin/AdminClient.html "Kafka 1.0 Javadoc"). 
