...
You can run Java applications that use the Kafka Streams library without any additional configuration or requirements. Kafka Streams also provides the ability to receive notification of the various states of the application. The ability to monitor the runtime status is discussed in [the monitoring guide](../../../operations/monitoring#streams-monitoring).
...
[![../../../images/streams-elastic-scaling-1.png](../../../images/streams-elastic-scaling-1.png)](../../../images/streams-elastic-scaling-1.png)
...
[![../../../images/streams-elastic-scaling-2.png](../../../images/streams-elastic-scaling-2.png)](../../../images/streams-elastic-scaling-2.png)
...
[![../../../images/streams-elastic-scaling-3.png](../../../images/streams-elastic-scaling-3.png)](../../../images/streams-elastic-scaling-3.png)
...
For more information, see [Standby Replicas](../config-streams#streams-developer-guide-standby-replicas).
