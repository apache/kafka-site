...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/3.8.1/kafka_2.13-3.8.1.tgz "Kafka downloads") the 3.8.1 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/38/images/streams-table-updates-02.png) ![](/38/images/streams-table-updates-01.png)
...
[Previous](/38/streams) [Next](/38/streams/tutorial)
