...
The current state of this member; possible values are leader, candidate, voted, follower, unattached.
</td>  
<td>
...
{{< include-html file="/static/33/generated/producer_metrics.html" >}} 
...
{{< include-html file="/static/33/generated/consumer_metrics.html" >}} 

## Connect Monitoring

A Connect worker process contains all the producer and consumer metrics as well as metrics specific to Connect. The worker process itself has a number of metrics, while each connector and task have additional metrics. {{< include-html file="/static/33/generated/connect_metrics.html" >}} 
