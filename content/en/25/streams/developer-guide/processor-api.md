...
For a complete list of available API functionality, see the [Streams](/25/javadoc/org/apache/kafka/streams/package-summary.html) API docs.
...
Persistent `KeyValueStore<K, V>` | RocksDB | Yes (enabled by default) | 
  ...
  * Available [store variants](/25/javadoc/org/apache/kafka/streams/state/Stores.html#persistentKeyValueStore-java.lang.String-): time window key-value store, session window key-value store.
...
In-memory `KeyValueStore<K, V>` | - | Yes (enabled by default) | 
  ...
  * Available [store variants](/25/javadoc/org/apache/kafka/streams/state/Stores.html#inMemoryKeyValueStore-java.lang.String-): time window key-value store, session window key-value store.
