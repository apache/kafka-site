...
The [Kafka Streams demo](/streams/quickstart) and the [app development tutorial](/34/streams/tutorial) demonstrate how to code and run such a streaming application from start to finish. 
