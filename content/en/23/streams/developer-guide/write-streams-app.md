...
---|---|---|---  
`org.apache.kafka` | `kafka-streams` | `2.3.0` | (Required) Base library for Kafka Streams.  
`org.apache.kafka` | `kafka-clients` | `2.3.0` | (Required) Kafka client library. Contains built-in serializers/deserializers.  
`org.apache.kafka` | `kafka-streams-scala` | `2.3.0` | (Optional) Kafka Streams DSL for Scala library to write Scala Kafka Streams applications. When not using SBT you will need to suffix the artifact ID with the correct version of Scala your application is using (`_2.11`, `_2.12`)  
...
[Previous](/23/streams/developer-guide/) [Next](/23/streams/developer-guide/config-streams)
