...
iterator-duration-avg | The average time spent between creating an iterator and closing it, in nanoseconds. | kafka.streams:type=stream-state-metrics,thread-id=([-.\w]+),task-id=([-.\w]+),[store-scope]-id=([-.\w]+)  
iterator-duration-max | The maximum time spent between creating an iterator and closing it, in nanoseconds. | kafka.streams:type=stream-state-metrics,thread-id=([-.\w]+),task-id=([-.\w]+),[store-scope]-id=([-.\w]+)  
oldest-iterator-open-since-ms | The UNIX timestamp the oldest still open iterator was created, in milliseconds. | kafka.streams:type=stream-state-metrics,thread-id=([-.\w]+),task-id=([-.\w]+),[store-scope]-id=([-.\w]+)  
