...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/2.2.0/kafka_2.12-2.2.0.tgz "Kafka downloads") the 2.2.0 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.12) here: 
...
![](/22/images/streams-table-updates-02.png) ![](/22/images/streams-table-updates-01.png)
...
[Previous](/22/streams) [Next](/22/streams/tutorial)
