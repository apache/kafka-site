...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/0.11.0.2/kafka_2.11-0.11.0.2.tgz "Kafka downloads") the 0.11.0.2 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.11) here: 
...
![](/0110/images/streams-table-updates-02.png) ![](/0110/images/streams-table-updates-01.png)
