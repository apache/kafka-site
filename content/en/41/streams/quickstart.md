...
This quickstart example will demonstrate how to run a streaming application coded in this library. Here is the gist of the `[WordCountDemo](https://github.com/apache/kafka/blob/4.1/streams/examples/src/main/java/org/apache/kafka/streams/examples/wordcount/WordCountDemo.java)` example code. 
...
[Download](https://www.apache.org/dyn/closer.cgi?path=/kafka/4.1.2/kafka_2.13-4.1.2.tgz "Kafka downloads") the 4.1.2 release and un-tar it. Note that there are multiple downloadable Scala versions and we choose to use the recommended version (2.13) here: 
...
![](/41/images/streams-table-updates-02.png) ![](/41/images/streams-table-updates-01.png)
