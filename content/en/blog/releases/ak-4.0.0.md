...
Ready to get started with Apache Kafka 4.0.0? Check out all the details in the [upgrade notes](https://kafka.apache.org/documentation.html#upgrade_4_0_0) and the [release notes](https://archive.apache.org/dist/kafka/4.0.0/RELEASE_NOTES.html), and [download](https://kafka.apache.org/downloads) Apache Kafka 4.0.0.
